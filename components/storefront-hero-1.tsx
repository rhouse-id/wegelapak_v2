    ...
    const featuredProducts = [
        {
            ...
            isNew: true,
            isOnSale: false,
            image: 'https://images.unsplash.com/photo-1631155986512-deb57fd69571?q=80&w=687&auto=format&fit=crop',
        ...
        },
        {
            ...
            isNew: false,
            isOnSale: true,
            image: 'https://images.unsplash.com/photo-1642653101681-0b7cdb802e60?q=80&w=735&auto=format&fit=crop',
            colors: ['#1F2937', '#F3F4F6', '#F59E0B'],
        },
    ];

    return (
        <div className="relative overflow-hidden bg-linear-to-br from-primary/5 to-background">
            <div className="lg::py-20 relative z-10 container mx-auto flex flex-col items-center justify-between gap-12 px-4 py-16 lg:px-12 xl:flex-row xl:items-start">
                ...
                <div className="mx-auto max-w-xl text-center lg:mx-0 xl:text-left">
                    ...
                    <p className="mt-8 text-lg text-muted-foreground">
                        Discover premium quality products designed for your
                        everyday life. Experience the perfect blend of style,
