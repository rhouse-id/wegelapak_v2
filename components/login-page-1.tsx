        ...
        <Card className='relative w-full max-w-md border-none p-8 shadow-2xl'>
          ...
          <form className='space-y-6'>
            <div className='relative'>
              <Input type='email' placeholder='me@example.com' className='bg-transparent ps-10' autoComplete='email' />
            ...
            <div className='flex items-center justify-between'>
              <div className='flex items-center space-x-2'>
                <Checkbox id='remember3' className='data-[state=checked]:bg-primary bg-transparent' />
                <label
                  htmlFor='remember3'
